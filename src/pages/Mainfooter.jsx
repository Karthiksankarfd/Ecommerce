...
import { FaFacebook, FaInstagram, FaMailBulk, FaPhone, FaTwitter, FaWhatsapp } from "react-icons/fa";
  ...
  return (
    <>
      <div className="footercontainer w-full flex  lg:flex-row sm:flex-col md:flex-col gap-y-2 gap-x-2 bg-black p-2 justify-center items-center h-72 sm:h-auto">
        ...
        <div className="Social_media_links w-1/4 p-2  h-fit flex flex-col gap-y-3 sm:w-full md:w-full">
        ...
        <div className="w-1/4 p-2  sm:w-full md:w-full flex flex-wrap justify-start items-start h-36 text-neutral-400">
            <div className="contact flex justify-start items-center gap-x-3">
                ...
                <span className="text-neutral-400"> <p>+91 78765 43222</p></span>
            </div>
