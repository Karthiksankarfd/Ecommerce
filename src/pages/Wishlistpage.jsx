...
const Wishlistpage = () => {
  // login context
  const auth = useAuth();
  const { wishlist, addTocart, setWishlist, showAlert, cart, setShowAlert } =
            ...
            <div className="pagetitle p-5 bg-neutral-400 w-full text-center flex flex-col justify-center items-center relative">
              ...
              <div className="w-full ">
                <p className="font-semibold text-xs">
                  {" "}
                  Order Now To Get 30% OFF By Using The Code{" "}
                  <span className="text-green-400 text-sm">FEB2024</span>{" "}
                </p>
              </div>
