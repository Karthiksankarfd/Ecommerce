  ...
  return (
    <>
      {auth.user ? (
        <>
          {" "}
          <div className=" sm:hidden md:hidden w-full h-auto lg:flex lg:flex-row justify-center items-start bg-white gap-x-5 py-10 ">
      ...
      {auth.user ? (
            ...
            <div className="profilebanner flex flex-col gap-y-2 py-2 w-full overflow-hidden relative">
              ...
              <div className="wow_content relative z-20">
                <p className="text-xs ">
                  ...
                  and <span className="font-semibold">earn</span> <br />{" "}
                  <span className="font-semibold">supercoins</span> by becoming
                  an member
                </p>
              </div>
              <div>
        ...
        <div className="flex flex-col gap-y-2 justify-center items-center h-96 w-full">
          <img
            className="lg:h-24 sm:h-24"
            src="https://th.bing.com/th/id/R.33e45fba58273198302c9db0d482778d?rik=eE5COOY43LWDTg&riu=http%3a%2f%2fcdn.onlinewebfonts.com%2fsvg%2fimg_150170.png&ehk=u3gzXDIrg3raZt%2fOZVxdAd4MHoboaOEkEuHPEFmhsOc%3d&risl=&pid=ImgRaw&r=0"
            alt=""
          />
          <button
            className="bg-black sm:w-1/2 lg:w-fit lg:px-2  text-center text-white  py-2"
            onClick={() => {
              auth.openModal();
            }}
          >
